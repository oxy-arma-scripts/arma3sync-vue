          ...
          <v-row>
            <v-col cols="12">
              <v-checkbox
                ...
                :label="
                  $t('settings.game.arguments.loadingSpeedup.noSplash.label')
                "
                :hint="
                  $t('settings.game.arguments.loadingSpeedup.noSplash.hint')
                "
                density="comfortable"
                persistent-hint
              />
            ...
            <v-col cols="12">
              <v-checkbox
                ...
                :label="
                  $t('settings.game.arguments.loadingSpeedup.skipIntro.label')
                "
                :hint="
                  $t('settings.game.arguments.loadingSpeedup.skipIntro.hint')
                "
                density="comfortable"
                persistent-hint
              />
          ...
          <v-row>
            <v-col cols="12">
              ...
              <v-text-field
                ...
                :label="
                  $t('settings.game.arguments.profileOptions.profiles.label')
                "
                :hint="
                  $t('settings.game.arguments.profileOptions.profiles.hint')
                "
                density="comfortable"
                variant="underlined"
                persistent-hint
          ...
          <v-row>
            <v-col cols="12">
              <v-checkbox
                ...
                "
                :label="
                  $t('settings.game.arguments.performance.enableHT.label')
                "
            ...
            <v-col cols="12">
              <v-checkbox
                ...
                :label="
                  $t('settings.game.arguments.performance.hugePages.label')
                "
          ...
          <v-row>
            <v-col cols="12">
              <v-checkbox
                ...
                :label="
                  $t('settings.game.arguments.developerOptions.noPause.label')
                "
                :hint="
                  $t('settings.game.arguments.developerOptions.noPause.hint')
                "
                density="comfortable"
                persistent-hint
              />
            ...
            <v-col cols="12">
              <v-checkbox
                ...
                :label="
                  $t('settings.game.arguments.developerOptions.debug.label')
                "
                :hint="
                  $t('settings.game.arguments.developerOptions.debug.hint')
                "
                density="comfortable"
                persistent-hint
              />
            ...
            <v-col cols="12">
              <v-checkbox
                ...
                :label="
                  $t('settings.game.arguments.developerOptions.noLogs.label')
                "
                :hint="
                  $t('settings.game.arguments.developerOptions.noLogs.hint')
                "
                density="comfortable"
                persistent-hint
              />
            ...
            <v-col cols="12">
              ...
              <v-text-field
                ...
                :label="
                  $t('settings.game.arguments.developerOptions.language.label')
                "
                :hint="
                  $t('settings.game.arguments.developerOptions.language.hint')
                "
                density="comfortable"
                variant="underlined"
                persistent-hint
          ...
          <v-row>
            <v-col cols="12">
              <v-text-field
                ...
                "
                :hint="
                  $t('settings.game.arguments.performanceAdvanced.maxVram.hint')
                "
                density="comfortable"
                variant="underlined"
                type="number"
            ...
            <v-col cols="12">
              <v-checkbox
                ...
                :label="
                  $t('settings.game.arguments.performanceAdvanced.noCB.label')
                "
                :hint="
                  $t('settings.game.arguments.performanceAdvanced.noCB.hint')
                "
                density="comfortable"
                persistent-hint
              />
            ...
            <v-col cols="12">
              <v-text-field
                ...
                :label="
                  $t('settings.game.arguments.performanceAdvanced.malloc.label')
                "
                :hint="
                  $t('settings.game.arguments.performanceAdvanced.malloc.hint')
                "
                density="comfortable"
                variant="underlined"
                persistent-hint
